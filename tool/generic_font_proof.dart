...
void main() {
  ...
  final testFonts = [
    ...
    ('NotoSansKhmer-Regular', '/Users/hengmengsroin/.gemini/antigravity-ide/brain/124ef2f0-1d61-4b71-b0d3-671001f9375b/scratch/NotoSansKhmer-Regular.ttf'),
    ('KhmerOS_battambang', '/Users/hengmengsroin/Library/Fonts/KhmerOS_battambang.ttf'),
    ('Hanuman-Regular', '/Users/hengmengsroin/Library/Fonts/Hanuman-Regular.ttf'),
  ];
  ...
  for (final (fontName, fontPath) in testFonts) {
    ...
    for (final word in testWords) {
      ...
      bufferSetClusterLevel(buffer, 0); // HB_BUFFER_CLUSTER_LEVEL_MONOTONE_GRAPHEMES
      ...
      for (int i = 0; i < count; i++) {
        ...
        glyphDescriptions.add('gid:${info.codepoint}(cl:${info.cluster}, adv:${pos.x_advance}, off:[${pos.x_offset},${pos.y_offset}])');
      }
