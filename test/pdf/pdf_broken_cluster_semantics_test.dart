...
void main() {
  group('PDF Broken-Cluster Semantics Tests', () {
    ...
    test(
        'Synthetic dotted circle appears visually (GID 272) but is NEVER emitted into /ToUnicode CMap',
        () async {
    ...
    test('Explicit dotted circle typed by user is preserved in /ToUnicode',
        () async {
