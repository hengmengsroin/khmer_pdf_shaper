...
void main() {
  group('Phase 7 — Item 13: Comprehensive Visual Regression Document Tests',
    ...
    test(
        'Generates comprehensive golden visual document with 206 fixtures, extremes, mixed scripts and layouts',
        () async {
            ...
            children: [
              KhmerText(
                ...
                style: const pw.TextStyle(
                    fontSize: 18, color: PdfColors.indigo900),
              ...
              KhmerText(
                ...
                style: const pw.TextStyle(
                    fontSize: 11, color: PdfColors.blueGrey800),
              ),
              pw.SizedBox(height: 4),

              // 2. Representative categories
              KhmerText('1. Basic & Pre-base: ក ខ គ | គេ តែ កៃ កៅ',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('2. Above & Below Marks: កី កឹ កឺ | គុ គូ គួ',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('3. Split Matras & Robat: កោះ កាំ កុំ | ធម៌ ពណ៌',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('4. Subscripts & COENG RO: ក្ក ក្ខ | ក្រ គ្រ ស្រ',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('5. Stacked Marks & Clusters: ក្ដាំង សង្គ្រាម កញ្ឆា',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText(
                  '6. Broken Cluster & Dotted Circle: \u25CC\u17B6 | \u17D2\u1780 | \u25CC\u17C1\u1780',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText(
                  '7. Joiners (ZWJ / ZWNJ): ក\u200D្\u200Dក | ក\u200C្\u200Cក | ឥ\u200Dក',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText(
                  '8. Spaces (SPACE / NBSP / ZWSP): [ក ខ] | [ក\u00A0ខ] | [ក\u200Bខ]',
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText(
                  '9. Mixed Script: Invoice សួស្តី 123 | \$10 កម្ពុជា | info@ខ្មែរ.com',
                  style: const pw.TextStyle(fontSize: 10)),
              pw.SizedBox(height: 4),

              // 3. Alignments
              KhmerText('Left Aligned: តម្រឹមឆ្វេង សួស្តី',
                  textAlign: pw.TextAlign.left,
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('Center Aligned: តម្រឹមកណ្តាល សួស្តី',
                  textAlign: pw.TextAlign.center,
                  style: const pw.TextStyle(fontSize: 10)),
              KhmerText('Right Aligned: តម្រឹមស្តាំ សួស្តី',
              ...
              pw.Row(
                ...
                children: [
                  ...
                  KhmerText('10pt អក្សរ',
                      style: const pw.TextStyle(fontSize: 10)),
                  KhmerText('14pt អក្សរ',
                      style: const pw.TextStyle(fontSize: 14)),
                  KhmerText('18pt អក្សរ',
      ...
      for (int i = 0; i < fixtures.length; i += chunkSize) {
        final end =
            (i + chunkSize < fixtures.length) ? i + chunkSize : fixtures.length;
                  ...
                  return pw.Padding(
                    ...
                    child: pw.Row(
                      children: [
                        ...
                        pw.SizedBox(
                          width: 140,
                          child: KhmerText(category,
                              style: const pw.TextStyle(
                                  fontSize: 9, color: PdfColors.blueGrey600)),
                        ),
                        pw.Expanded(
                          child: KhmerText(text,
