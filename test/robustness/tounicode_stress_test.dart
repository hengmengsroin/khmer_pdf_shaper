...
void main() {
  group('Phase 7 — Item 12: ToUnicode Stress Tests', () {
    test(
        'KhmerToUnicodeCmap chunks entries into <= 100 pairs per beginbfchar block',
        () {
      ...
      final beginMatches =
          RegExp(r'(\d+)\s+beginbfchar').allMatches(output).toList();
    ...
    test(
        'End-to-end PDF with 300 unique Khmer clusters generates valid ToUnicode stream',
        () async {
